...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'contact', 'key' => 'primary_email', 'type' => 'string', 'value' => null, 'is_public' => true],
            ['group' => 'contact', 'key' => 'phone', 'type' => 'string', 'value' => null, 'is_public' => true],
            ...
            ['group' => 'social', 'key' => 'linkedin_url', 'type' => 'string', 'value' => null, 'is_public' => true],
