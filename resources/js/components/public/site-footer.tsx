    ...
    return (
        <footer className="bg-slate-950 text-white">
                ...
                <div>
                    ...
                    <ul className="mt-5 grid gap-3">
                        {services.slice(0, 5).map((service) => (
                            <li key={service.key} className="text-sm text-slate-300">
            ...
            <div className="border-t border-white/10">
                <div className="mx-auto flex max-w-7xl flex-col gap-3 px-5 py-5 text-sm text-slate-400 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
                    <p>ELITEDATA</p>
                    <p>
                        {currentLocale === 'ar'
